...
% Solve Kd = F equation
d_temp_LU = K \ F;
d_temp_gmres_tol1 = gmres(K,F,10000,1e-2,10000);
d_temp_gmres_tol2 = gmres(K,F,10000,1e-4,10000);
d_temp_gmres_tol3 = gmres(K,F,10000,1e-6,10000);

mean_difference1 = mean(abs(d_temp_LU-d_temp_gmres_tol1))
mean_difference2 = mean(abs(d_temp_LU-d_temp_gmres_tol2))
mean_difference3 = mean(abs(d_temp_LU-d_temp_gmres_tol3))
...
% hold on;
% plot(x_sam, y_sam, '-k','LineWidth',3);
% % saveas(gcf,'tol = 1e-2','jpg')
% % saveas(gcf,'tol = 1e-4','jpg')
% % saveas(gcf,'tol = 1e-6','jpg')
% 
% 
% 
% 
